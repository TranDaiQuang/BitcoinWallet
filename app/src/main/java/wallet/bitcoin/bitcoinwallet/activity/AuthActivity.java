...
public class AuthActivity extends AppCompatActivity {
    ...
    public void onUserRegistered(final String name, String pass, boolean isRegister) {
    ...
    public static class MyAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 1:
                    if (list.get(1) == null) {
                        list.put(1, TutorialFirstItem.newInstance(TutorialFirstItem.ICON_TRANSACT));
                    }
                    return list.get(1);

                case 2:
                    if (list.get(2) == null) {
                        list.put(2, TutorialFirstItem.newInstance(TutorialFirstItem.ICON_PIN));
                    }
                    return list.get(2);
