...
public class AddressAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected class AddressViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final WalletAddress address, int pos) {
            Utility.setDrawableColor(ivIcon, App.getContext().getResources().getColor(getColor(address.id)));
    ...
    private int getColor(String id){
        switch (id.hashCode() % 9){
            case 0:
                return R.color.address_color_1;
            case 1:
                return R.color.address_color_2;
            case 2:
                return R.color.address_color_3;
            case 3:
                return R.color.address_color_10;
            case 4:
                return R.color.address_color_5;
            case 5:
                return R.color.address_color_6;
            case 6:
                return R.color.address_color_7;
            case 7:
                return R.color.address_color_8;
            case 8:
                return R.color.address_color_9;
        }

        return R.color.onboadingback_5;
    }
