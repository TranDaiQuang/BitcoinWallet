...
public class TutorialFourthItem extends TutorialItemFragment {
    ...
    private void init() {
        Utility.setDrawableColor(ivIcon, App.getContext().getResources().getColor(R.color.text_color_light));
        Utility.setDrawableColor(ivIcon1, App.getContext().getResources().getColor(R.color.text_color_light));
